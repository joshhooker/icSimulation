...
MMTrackingInformation::MMTrackingInformation(G4int type, G4double energy, G4double cmEnergy, G4double cmLightTheta,
  ...
  fReactionType(type), fEnergy(energy), fCMEnergy(cmEnergy), fCMLightTheta(cmLightTheta), fLabLightTheta(labLightTheta),
